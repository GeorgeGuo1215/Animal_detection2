...
function ChatPage() {
  ...
  async function send() {
    ...
    setMessages(prev => [...prev, { id: newId(), role: 'user', content: text, status: 'complete', created_at: new Date().toISOString() }]); setInput(''); setBusy(true); setError(''); setPhase('queued'); draftAnswer.current = ''; lastEvent.current = 0
