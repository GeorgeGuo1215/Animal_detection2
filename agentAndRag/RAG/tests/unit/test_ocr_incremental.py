...
_RAG = Path(__file__).resolve().parents[2]
...
from RAG.maintenance.indexing.append_books_to_category_indexes import (  # noqa: E402
    book_id_from_source,
)
from RAG.maintenance.indexing.copy_ocr_mmd_to_raw import copy_books  # noqa: E402
from RAG.maintenance.indexing.rebuild_category_indexes import (  # noqa: E402
    CatalogBook,
